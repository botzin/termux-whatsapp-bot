...
const ovo = '5573981044096';
const pulsa = '5573981044096';
const dana = '5573981044096';
const BotName = 'itachi'; 
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:srs.itachin\n' // Nama kamu
            + 'ORG:itachi;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5573981044096:+62 822-2301-4661\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Leia o código QR com o WhatsApp!`);
});
    ...
    axios.get(`https://tobz-api.herokuapp.com/api/textpro?theme=wolflogo1&text1=${text1}&text2=${text2}&apikey=${tobzkey}`).then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, '[ WAIT ] Sedang diproses⏳ Por favor espere um momento', MessageType.text, { quoted: m })
            conn.sendMessage(id, buf, MessageType.image, { quoted: m });
        })
    })
}
    ...
    axios.get(`https://tobz-api.herokuapp.com/api/textpro?theme=lionlogo&text1=${text1}&text2=${text2}&apikey=${tobzkey}`).then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, '[ ESPERAR ] Em andamento ⏳ Por favor espere um momento', MessageType.text, { quoted: m })
            conn.sendMessage(id, buf, MessageType.image, { quoted: m });
        })
    })
}
...
_Use ponto (.) E minúsculas para executar o comando_
_Ex significa exemplo_͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏
...
├≽️ * .Chatprank (texto1 / texto2) *
├ _Ex : .É perceptivo Bang / sete_ 
├≽️ *.Alay (teks)*
├ _Ex : .Alay hai udin_ 
╰────────────⊱
